...
Public Class ApplicationDbContext
    ...
    Public Property UserInfo As DbSet(Of UserInfo)
    Public Property Product As DbSet(Of ProductItem)
    Public Property ProductCategories As DbSet(Of ProductCategories)
    Public Property CountryState As DbSet(Of CountryState)
    Public Property Review As DbSet(Of Review)
    Public Property CustomerOrder As DbSet(Of CustomerOrder)
End Class
...
Public Class ApplicationRoleManager
    ...
    Public Sub New(roleStore As IRoleStore(Of ApplicationRole, String))
    ...
    Public Shared Function Create(options As IdentityFactoryOptions(Of ApplicationRoleManager), context As IOwinContext) As ApplicationRoleManager
        Return New ApplicationRoleManager(New RoleStore(Of ApplicationRole)(context.[Get](Of ApplicationDbContext)()))
    End Function
End Class
